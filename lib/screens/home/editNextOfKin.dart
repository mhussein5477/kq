    ...
    setState(() {
      _nextOfKin.add(
        NextOfKin(
          ...
          surName: '',
          relationship:
              _availableRelationships.isNotEmpty ? _availableRelationships.first : '',
          phoneNo: '',
          emailAddress: '',
          address: '',
          isPrimary: false,
                  ...
                  children: [
                    ...
                    if (_nextOfKin.isEmpty)
                      ...
                      ..._nextOfKin.asMap().entries.map((entry) {
                        ...
                        return _buildNOKCard(nok, index, isDarkMode, theme);
                      }).toList(),
                    const SizedBox(height: 16),
                    OutlinedButton.icon(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CheckboxListTile(
            title: const Text('Set as Primary', style: TextStyle(fontSize: 14)),
            value: nok.isPrimary,
            onChanged: (value) {
              setState(() {
                if (value == true) {
